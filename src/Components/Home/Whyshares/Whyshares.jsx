        ...
        <div>
            ...
            <div className="flex p-5 gap-5">
                <div className="flex-1 flex flex-col justify-center items-center">
                   <h1 className="text-3xl font-bold text-orange-600 mt-5">Reduce Food Waste</h1>
            ...
            <div className="flex flex-row-reverse p-5 gap-5">
                <div className="flex-1 flex flex-col justify-center items-center">
                   <h1 className="text-3xl font-bold text-orange-600 mt-5">Fight Hunger</h1>
            ...
            <div className="flex p-5 gap-5">
                <div className="flex-1 flex flex-col justify-center items-center">
                   <h1 className="text-3xl font-bold text-orange-600 mt-5">Build a community</h1>
